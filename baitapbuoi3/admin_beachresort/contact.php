			...
			<div id="header">
				...
				<div id="navigation">
					<ul>
						...
						<li>
							<a href="about.phpindex.php">About</a>
						</li>
						<li>
							<a href="rooms.phpindex.php">Rooms</a>
						</li>
						<li>
							<a href="dives.phpindex.php">Dive Site</a>
						</li>
						<li>
							<a href="foods.phpindex.php">Food</a>
						</li>
						<li>
							<a href="news.phpindex.php">News</a>
						</li>
						<li class="selected">
							<a href="contact.phpindex.php">Contact</a>
						</li>
					</ul>
				</div>
			</div>
