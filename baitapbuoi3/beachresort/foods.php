						...
						<div class="body">
							...
							<ul id="foods">
								...
								<li>
									...
									<div class="infos">
										<a href="foods.php"><img src="/518a/baitapbuoi3/admin_beachresort/foods/<?php echo $se_user['imgfood']; ?>" alt="Img" height="169" width="780"><span class="cover"></span></a>
										<p>
											<span><?php echo $se_user['description']; ?></span>Lorem ipsum dolor sit amet consectetur adipisicing elit.
										</p>
									</div>
								</li>
							<?php
